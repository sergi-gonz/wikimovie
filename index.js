...
document.addEventListener("DOMContentLoaded", function () {
  ...
  menu.innerHTML = `
    <div class="menu-item" id="genre-item">
    ...
    <div class="genre-menu" id="submenu-genre">
      <div class="genre-menu-item">Acción</div>
      <div class="genre-menu-item">Aventura</div>
      <div class="genre-menu-item">Comedia</div>
      <div class="genre-menu-item">Drama</div>
      <div class="genre-menu-item">Fantasía</div>
      <div class="genre-menu-item">Ciencia Ficción</div>
      <div class="genre-menu-item">Terror</div>
      <div class="genre-menu-item">Thriller</div>
      <div class="genre-menu-item">Musical</div>
    </div>
    <div class="menu-item">
  ...
  const genreMenu = document.querySelector("#submenu-genre");
